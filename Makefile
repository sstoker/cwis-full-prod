...
# Postfix mail relay - must come after ENVIRONMENT so drupal depends_on includes postfix
...
SERVICES := $(REQUIRED_SERVICES) $(FCREPO_SERVICE) $(WATCHTOWER_SERVICE) $(ETCD_SERVICE) $(DATABASE_SERVICES) $(ENVIRONMENT) $(MAIL_SERVICE) $(SECRETS) $(TRAEFIK_SERVICE) $(ACME)

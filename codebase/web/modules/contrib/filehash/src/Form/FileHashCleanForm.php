...
class FileHashCleanForm extends ConfirmFormBase {
  ...
  public function getDescription() {
    ...
    return $this->formatPlural(count($this->columns), 'Are you sure you want to delete all data for one disabled hash algorithm column (@algorithms)?', 'Are you sure you want to delete all data for @count disabled hash algorithm columns (@algorithms)?', [
      '@count' => count($this->columns),
      '@algorithms' => implode(', ', $this->columns),
    ]);
  }
